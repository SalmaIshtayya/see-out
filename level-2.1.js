...
function mouseDown(e) {
  ...
  if (e.target.classList.contains("block")) {
    ...
    if (selectedBlock.classList[1].slice(6) > 4 && selectedBlock.parentElement.classList.contains("type")) {
      ...
      selectedBlock.parentElement.style.height = selectedBlock.parentElement.offsetHeight - 20 + "px";
  ...
  if (selectedBlock) {
    ...
    if (selectedBlock.classList[1].slice(6) > 4) {
      if (selectedBlock.parentElement === menu) {
        if (elementUnderMouse === null || !elementUnderMouse.parentElement.classList.contains("type") && elementUnderMouse !== allBlocks && elementUnderMouse.parentElement !== allBlocks) {
          blocks.forEach((block) => {
